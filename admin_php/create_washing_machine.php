...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deviceSql = "INSERT INTO device (roomID, device_name, device_type) VALUES ($roomID, '$deviceName', 'washing machine')";
    ...
    if ($conn->query($deviceSql) === TRUE) {
        ...
        $lightSql = "INSERT INTO washing_machine (deviceID,mode,isOpen) VALUES ($deviceID,'', 0)";
