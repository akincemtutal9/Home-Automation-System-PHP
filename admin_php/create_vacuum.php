...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deviceSql = "INSERT INTO device (roomID, device_name, device_type) VALUES ($roomID, '$deviceName', 'robot vacuum cleaner')";

    if ($conn->query($deviceSql) === TRUE) {

        $deviceID = $conn->insert_id;

        $lightSql = "INSERT INTO robot_vacum_cleaner (deviceID,mode,isOpen) VALUES ($deviceID,'', 0)";
