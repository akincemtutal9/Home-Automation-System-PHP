...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deviceSql = "INSERT INTO device (roomID, device_name, device_type) VALUES ($roomID, '$deviceName', 'electric blanket')";

    if ($conn->query($deviceSql) === TRUE) {

        $deviceID = $conn->insert_id;

        $lightSql = "INSERT INTO electric_blanket (deviceID, isOpen) VALUES ($deviceID, 0)";
